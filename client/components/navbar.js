          ...
          isLoggedIn
            ? <ul className="nav navbar-nav navbar-right">
                ...
                <li className="active dropdown singleDrop">
                  <a><Link to="/" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">home <i className="fa fa-angle-down" aria-hidden="true"></i></Link></a>
                </li>   
                <li>
              ...
              : <ul className="nav navbar-nav navbar-right">
                <li className="active dropdown singleDrop">
                <Link to="/" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">home <i className="fa fa-angle-down" aria-hidden="true"></i></Link>
                </li>
