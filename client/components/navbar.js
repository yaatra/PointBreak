    ...
    return (<div className={cssClass}>
        ...
        <div className="navbar-header">
              ...
              {cssClass === 'nav-wrapper' ?
                <Link className="navbar-brand" to="/"><img src={(process.env.PROD_URL) ? `{process.env.PROD_URL}assets/SCSS/img/logo.png` : 'localhost:8080/assets/SCSS/img/logo.png' } alt="PointBreak" /></Link>
                :
                <Link className="navbar-brand" to="/"><img src={(process.env.PROD_URL) ? `{process.env.PROD_URL}assets/SCSS/img/logo-blue.png`  : 'localhost:8080/assets/SCSS/img/logo-blue.png'} alt="PointBreak" /></Link>
              }
            </div>
