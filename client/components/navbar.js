    ...
    return (<div className={cssClass}>
        ...
        <div className="navbar-header">
              ...
              {cssClass === 'nav-wrapper' ?
                <Link className="navbar-brand" to="/"><img src="assets/SCSS/img/logo.png" alt="logo" /></Link>
                :
                <Link className="navbar-brand" to="/"><img src="assets/SCSS/img/logo-blue.png" alt="logo" /></Link>
              }
            </div>
