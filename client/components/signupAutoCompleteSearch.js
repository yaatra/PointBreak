...
// import {addSelectedAndAddedLocation} from '../store'

class SignupAutoCompleteSearch extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      address: '',
...
const mapDispatch = (dispatch) => {
  ...
  //     dispatch(addSelectedAndAddedLocation(location))
  //   }
  // }
}
export default connect(mapState, mapDispatch)(SignupAutoCompleteSearch)
