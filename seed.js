...
let data = {
  fitbitData: [
    {accessToken: '1312', weekSteps: [{steps: 6000}, {steps: 3000}, {steps: 7000}, {steps: 8000}, {steps: 1000}, {steps: 7000}, {steps: 6500}], weekAverageSteps: 5000, monthAverageSteps: 30000, threeMonthAverageSteps: 0},
    {accessToken: '1312',  weekSteps: [{steps: 9000}, {steps: 10000}, {steps: 12000}, {steps: 8000}, {steps: 9000}, {steps: 7000}, {steps: 9000}], weekAverageSteps: 7000, monthAverageSteps: 35000, threeMonthAverageSteps: 0},
    {accessToken: '1312', weekSteps: [{steps: 10000}, {steps: 10000}, {steps: 12000}, {steps: 8000}, {steps: 9000}, {steps: 7000}, {steps: 10000}], weekAverageSteps: 8000, monthAverageSteps: 49000, threeMonthAverageSteps: 0},
    {accessToken: '1312', weekSteps: [{steps: 9000}, {steps: 10000}, {steps: 12000}, {steps: 8000}, {steps: 9000}, {steps: 7000}, {steps: 9000}], weekAverageSteps: 9000, monthAverageSteps: 55000, threeMonthAverageSteps: 0},
    {accessToken: '1312', weekSteps: [{steps: 9000}, {steps: 10000}, {steps: 12000}, {steps: 8000}, {steps: 9000}, {steps: 7000}, {steps: 9000}], weekAverageSteps: 9000, monthAverageSteps: 55000, threeMonthAverageSteps: 0}
  ],
  userData: [
    {firstName: 'Eren', lastName: 'Chen', gender: 'male', email: 'eren@gmail.com', password: '123', isAdmin: true, isProfessional: true, fitbitInfoId: 1,  height: 6.1, weight: 190, age: 27, avatar: '/images/student.png'},
    {firstName: 'Ranjeet', lastName: 'Sodhi', gender: 'male', email: 'ranjeet@gmail.com', password: '123', isAdmin: true, isProfessional: false, fitbitInfoId: 2,  height: 6, weight: 175, age: 38, avatar: '/images/man1.png'},
    {firstName: 'Bojan', lastName: 'Jovanovic', gender: 'male', email: 'bojan@gmail.com', password: '123', isAdmin: true, isProfessional: true, fitbitInfoId: 3,  height: 6.1, weight: 170, age: 26, avatar: '/images/man2.png'},
    {firstName: 'David', lastName: 'Eiber', gender: 'male', email: 'david@gmail.com', password: '123', isAdmin: true, isProfessional: false, fitbitInfoId: 4, height: 6.1, weight: 170, age: 25, avatar: '/images/boy.png'},
    {firstName: 'Eli', lastName: 'Zabeth', gender: 'female', email: 'eli@gmail.com', password: '123', isAdmin: false, isProfessional: false, fitbitInfoId: 5,  height: 5.1, weight: 115, age: 25, avatar: '/images/girl.png'}
  ],
  eventData: [
    ...
    {name: 'Jump the Hex', image: 'https://s7.favim.com/orig/150320/beach-happiness-happy-life-Favim.com-2579877.jpg', description: 'Experience the amazing Amazon rainforest views', date: '2017-12-14 8:30:00', difficulty: 7, categoryId: 4, destinationId: 4, location: 'New York, NY, United States', lat:40.7127837, lng:-74.00594130000002},
    ...
    {name: 'Sharky Barky', image: 'http://ftpcontent.worldnow.com/kfmb/images/shark_sandiego1.jpg', description: 'Sharks are our best friends!', date: '2018-01-18 10:15:00', difficulty: 4, categoryId: 2, destinationId: 2, location: 'San Francisco, CA, United States', lat:37.7749295, lng:-122.41941550000001},
    {name: 'Conquer Mount Blanc', image: 'https://www.alpine-guides.com/wp-content/uploads/2016/07/montlanc-2-1024x573.jpg', description: 'Climbing Mt. Blanc', date: '2018-02-22 10:15:00', difficulty: 8, categoryId: 3, destinationId: 3, location: 'San Francisco, CA, United States', lat:37.7749295, lng:-122.41941550000001},
  ...
  AssociatedLanguageData: [
    ...
    {userId: 5, languageId: 40},
  ],
  MessageData: [
    {content: "I've wanted to join the Paris Dakar for years!", userId: 1, eventId: 1},
    {content: "Me too!", userId: 2, eventId: 1},
    {content: "Anyone know what time the first race starts?", userId: 2, eventId: 1},
    {content: "It's at 9:30AM", userId: 1, eventId: 1},
    {content: "I'm so excited to go to Bangkok!", userId: 1, eventId: 2},
    {content: "Let's grab a coffee on race day", userId: 5, eventId: 2},
    {content: "Definitely!", userId: 3, eventId: 1},
    {content: "I've never been surfing before, but I'm looking forward to this event!", userId: 5, eventId: 3},
    {content: "We can help you", userId: 2, eventId: 3},
    {content: "Looking forward to the awesome waves!", userId: 3, eventId: 3},
    {content: "I've just created this event to see who's interested", userId: 2, eventId: 4},
    {content: "Count me in!", userId: 3, eventId: 4},
    {content: "Me too!", userId: 4, eventId: 4},
    {content: "Anyone here?", userId: 2, eventId: 5},
    {content: "Guess not yet!", userId: 4, eventId: 5},
    {content: "Surf's up in these shark-infested waters!", userId: 2, eventId: 6},
    {content: "Who is joining me on this climb?", userId: 1, eventId: 7},
    {content: "Any brave souls?", userId: 1, eventId: 7},
    {content: "Looking forward to this climb!", userId: 3, eventId: 8},
    {content: "Not sure if I will be joining just yet.", userId: 1, eventId: 8}
  ]
